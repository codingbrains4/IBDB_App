...
// in simulator we redefine to format for IBDB Developer console
...
{\
	NSString * exceptionName = [@"org.ibdb." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.ibdb";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIIBDBNativeItemNone = -1, 
	UIIBDBNativeItemSpinner = -2,
	UIIBDBNativeItemProgressBar = -3,
	
	UIIBDBNativeItemSlider = -4,
	UIIBDBNativeItemSwitch = -5,
	UIIBDBNativeItemMultiButton = -6,
	UIIBDBNativeItemSegmented = -7,
	
	UIIBDBNativeItemTextView = -8,
	UIIBDBNativeItemTextField = -9,
	UIIBDBNativeItemSearchBar = -10,
	
	UIIBDBNativeItemPicker = -11,
	UIIBDBNativeItemDatePicker = -12,
	
	UIIBDBNativeItemInfoLight = -13,
	UIIBDBNativeItemInfoDark = -14,
	
	UIIBDBNativeItemDisclosure = -15,
	
	UIIBDBNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all IBDB instances of

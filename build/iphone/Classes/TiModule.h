...
/**
 The base class for all IBDB modules
 */
...
/**
 IBDB Platform calls this method on startup.
 */
-(void)startup;

/**
 IBDB Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 IBDB Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 IBDB Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 IBDB Platform calls this method on resume.
 @param sender The sender of the event.
 */

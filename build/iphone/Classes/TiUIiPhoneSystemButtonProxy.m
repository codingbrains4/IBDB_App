...
MAKE_SYSTEM_PROP(ACTIVITY,UIIBDBNativeItemSpinner);
MAKE_SYSTEM_PROP(SPINNER,UIIBDBNativeItemSpinner);
MAKE_SYSTEM_PROP(INFO_LIGHT,UIIBDBNativeItemInfoLight);
MAKE_SYSTEM_PROP(INFO_DARK,UIIBDBNativeItemInfoDark);
MAKE_SYSTEM_PROP(DISCLOSURE,UIIBDBNativeItemDisclosure);
MAKE_SYSTEM_PROP(CONTACT_ADD,UIIBDBNativeItemContactAdd);
